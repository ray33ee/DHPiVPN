		...
		<div class="" style="display: flex">
			...
			<div class="" style="width: 90%">
				<div class="row clearfix">
					Add tx and rx speeds for all interfaces (eth0, incoming, outgoing) and uise speedtest-cli to initiate an internet speed test. Show internet usage of all processes?
				</div>
